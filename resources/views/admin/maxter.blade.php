...
<head>
    ...
    <meta name="description" content="Tuyển sinh đại học">
    <meta name="author" content="Phan Thế Hoàng">
    <title>Admin- Nhân viên cụm</title>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="{!! URL::route('cluster-staff.quan-ly-thong-tin-thi-sinh.listStudent')!!}">QUẢN LÝ THÔNG TIN</a>
            </div>
            <!-- /.navbar-header -->
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="{!! URL::route('cluster-staff.quan-ly-thong-tin-thi-sinh.listStudent')!!}">List Student</a>
                                </li>
                                <li>
                                    <a href="{!! URL::route('cluster-staff.quan-ly-thong-tin-thi-sinh.getStudent')!!}">Add Student</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
