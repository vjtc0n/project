...
@section('content')
    ...
    <form action="" method="post">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="txtUniversity" placeholder="Hãy nhập tên trường" autocomplete="off" />
        </div>
        <div class="form-group">
            <label>Mã trường</label>
            <input type="text" class="form-control" name="txtUniversityCode" placeholder="Hãy nhập mã trường" autocomplete="off" />
        </div>
        <div class="form-group">
